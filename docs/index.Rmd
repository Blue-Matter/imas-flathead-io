...
Tabulated below are a list of current issues / assumptions that should be addressed at the current stage of framework development (Table 1). Also tablulated is the current 'to-do' list for the Blue Matter team (Table 2) 
